        ...
        <div className="account-container container">
            <div className="row mt-5">
                <div className="col-md-2">
                    <h4><FontAwesomeIcon className="mr-2" icon={faUser}/>Thông tin tài khoản</h4>
                    <NavLink to={"/account/user/info"}
                             className="account-sidebar-link nav-link"
                             activeClassName="is-active">Thông tin tài khoản</NavLink>
                    {(localStorage.getItem("userRole") === "ADMIN") ?
                        <>
                            <NavLink to={"/account/admin/add"}
                                     className="account-sidebar-link nav-link"
                                     activeClassName="is-active">Thêm sản phẩm</NavLink>
                            <NavLink to={"/account/admin/perfumes"}
                                     className="account-sidebar-link nav-link"
                                     activeClassName="is-active">Danh sách sản phẩm</NavLink>
                            <NavLink to={"/account/admin/orders"}
                                     className="account-sidebar-link nav-link"
                                     activeClassName="is-active">Danh sách tất cả đơn đặt hàng</NavLink>
                            <NavLink to={"/account/admin/users"}
                                     className="account-sidebar-link nav-link"
                                     activeClassName="is-active">Danh sách khách hàng</NavLink>
                        </> :
                        <>
                            <NavLink to={"/account/user/edit"}
                                     className="account-sidebar-link nav-link"
                                     activeClassName="is-active">Đổi mật khẩu</NavLink>

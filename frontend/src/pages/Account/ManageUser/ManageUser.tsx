    ...
    return (
        <>
            <div className="container">
                {loading ? <Spinner/> :
                    <>
                        <h4><FontAwesomeIcon className="mr-2" icon={faUserEdit}/> Người dùng: {firstName} {lastName}</h4>
                        <div className="row mt-5 mb-4 border px-3 py-3">
                            <div className="col-md-4">
                                <p className="personal_data_item">Mã người dùng:
                                ...
                                <p className="personal_data_item">Vai trò:
                        ...
                        {userOrders.length === 0 ?
                            <h5 style={{textAlign: "center"}}>Đơn hàng trống</h5> :
                            <>

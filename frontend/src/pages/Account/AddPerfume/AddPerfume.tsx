...
const AddPerfume: FC = () => {
    ...
    return (
        <>
            <ToastShow showToast={showToast} message={"Đã thêm nước hoa thành công!"}/>
                    ...
                    <div className="form row mt-3">
                        ...
                        <div className="col">
                            ...
                            <input
                                ...
                                name="country"
                                value={country}
                                placeholder="Nhập quốc gia của nhà sản xuất"
                                onChange={handleInputChange}/>

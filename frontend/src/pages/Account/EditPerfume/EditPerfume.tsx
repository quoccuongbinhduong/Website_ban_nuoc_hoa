...
const EditPerfume: FC<RouteComponentProps<{ id: string }>> = ({match}) => {
    ...
    return (
        <>
            <ToastShow showToast={showToast} message={"Nước hoa đã chỉnh sửa thành công!"}/>
            <div className="container">
                <h4><FontAwesomeIcon className="mr-2" icon={faEdit}/>Sửa sản phẩm</h4>
                <form onSubmit={onFormSubmit}>
                    <div className="row mt-5">
                        <div className="col-md-6">
                            <div className="form-group row">
                                <label className="col-sm-4 col-form-label font-weight-bold">Tên sản phẩm: </label>
                            ...
                            <div className="form-group row">
                                <label className="col-sm-4 col-form-label font-weight-bold">Thể tích: </label>
                                <div className="col-sm-8">
                                    <input
                                        type="text"
                            ...
                            <div className="form-group row">
                                <label className="col-sm-4 col-form-label font-weight-bold">Tầng hương đầu: </label>
                                <div className="col-sm-8">
                                    <input
                                        type="text"
                            ...
                            <div className="form-group row">
                                <label className="col-sm-4 col-form-label font-weight-bold">Tầng hương giữa: </label>
                                <div className="col-sm-8">
                                    <input
                                        type="text"
                            ...
                            <div className="form-group row">
                                <label className="col-sm-4 col-form-label font-weight-bold">Tầng hương cuối: </label>
                                <div className="col-sm-8">
                                    <input
                                        type="text"

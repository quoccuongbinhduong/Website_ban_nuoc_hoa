                            ...
                            <div className="mx-3 my-3">
                                <div className="row">
                                    <div className="col-md-4">
                                        <label><span className="text-danger"><b>*</b></span> Tên</label>
                                        <input
                                            type="text"
                                        ...
                                        <label><span className="text-danger"><b>*</b></span> Nội dung</label>
                                    </div>
                                    <div className="col-md-8">
                                        <label><span className="text-danger"><b>*</b></span> Xếp hạng</label>
                                        <div>
                                            <StarRatingComponent
                                                name="star"
                                                starCount={5}
